...
class Sale(db.Model):
    SERVICE_FEE_RATE = 0.10  # 10% sourcing service fee on product cost — same rate as quotations
    ...
    service_fee_usd = db.Column(db.Float, default=0)  # locked in at creation time — 10% of items subtotal, when applied
